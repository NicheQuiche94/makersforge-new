...
import { Minus, Plus, Check, Users, Calendar, Shield, Target, Percent, X, Loader2, CheckCircle } from "lucide-react";
...
export function TeamBuildCalculatorLead() {
    ...
    try {
      const { error: insertError } = await supabase
        ...
        .insert({
          ...
          permanent_hires: permanentHires,
          contract_hires: contractHires,
          contract_duration: contractDuration,
          total_quote: calculations.teamTotal,
          payment_preference: paymentOption,
          status: "new",
        });
      ...
      await fetch("/api/email/notify-quote", {
        method: "POST",
        ...
        body: JSON.stringify({
          ...
          contractHires,
          contractDuration,
          totalQuote: calculations.teamTotal,
    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-brand-grey border border-white/10 rounded-2xl max-w-md w-full p-8 relative">
            <button
            ...
            {!isSubmitted ? (
              <>
                ...
                <p className="text-white/60 mb-6">
                  We&apos;ll hold this pricing and reach out within 24 hours to discuss your team build.
                </p>

                {/* Quote Summary */}
                <div className="bg-white/5 rounded-xl p-4 mb-6">
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-white/70 text-sm">Team Size</span>
                    <span className="text-white font-medium">
                      {permanentHires > 0 && `${permanentHires} permanent`}
                      {permanentHires > 0 && contractHires > 0 && " + "}
                      {contractHires > 0 && `${contractHires} contractors`}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white/70 text-sm">
                      {paymentOption === "single" ? "Total" : "Monthly"}
                    </span>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder:text-white/30 focus:outline-none focus:border-brand-orange"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-brand-orange text-white rounded-xl font-semibold hover:bg-brand-orange/90 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-white/60 mb-6">
                  We&apos;ll be in touch within 24 hours to discuss your {totalHires}-person team build.
                </p>
                <button
                  onClick={() => setShowModal(false)}
