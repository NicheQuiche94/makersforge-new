...
export const ROSTER: Profile[] = [
  ...
  },
  {
    ...
    role: "UA Lead",
    background:
      "15 years in marketing with 10 years specifically in mobile UA, backed by a PhD in Marketing. Currently UA Lead at a mobile games studio; managing a 5-person UA team end-to-end.",
    location: { code: "eu", label: "eu · remote" },
    industries: ["games", "apps"],
    gamesCat: ["casual"],
    appsCat: ["social"],
    ...
    channels: ["meta", "google", "tiktok", "programmatic"],
    budget: 3,
    expertise: ["scaling", "reactivation", "skan", "audience"],
    dayRateLabel: "£700 / day",
    dayRateBand: 2,
    rateMin: 700,
    salaryAnnualLabel: "£75,000 / year",
    salaryAnnual: 75000,
    available: true,
    availableFor: ["permanent", "contract"],
    summary:
      "15 years in marketing, 10 of them in mobile UA, backed by a PhD in Marketing. Runs a 5-person UA team end-to-end at a casual mobile games studio. Manages 7-figure monthly budgets on Google and Meta with deep hands-on channel coverage. Track record of hard scaling numbers (39% Google Play lift while holding ROAS d30, DAU 130K to 450K on a board game title, ARPU d7 +38% via GEO-specific flow) alongside advanced funnel work.",
    skills: [
      "User Acquisition Leadership",
      "Team Building & Management",
      "Casual, Idle, Board & Dating Verticals",
      "IAA / IAP / Hybrid Monetisation",
      "Meta / Google / TikTok / AppLovin / Unity / Mintegral / Liftoff",
      "SKAN & AEM",
      "Re-engagement & LTV Growth",
      "DSP Scaling (Liftoff, DBM, Spotad)",
      "Adjust / AppsFlyer / Singular",
      "Tableau / PowerBI / Firebase / Incrmntal / Fraudscore",
      "Creative Testing Frameworks",
      "Funnel & Flow Optimisation",
    ],
    experience: [
      "15 years in marketing with 10 years specifically in mobile UA, backed by a PhD in Marketing.",
      "Currently UA Lead at a mobile games studio with IAA monetisation. Built and manages a 5-person UA team end-to-end. Scaled a casual title by 39% on Google Play while holding ROAS d30 stable across GEOs despite declining organic traffic. Grew a board game title's DAU from 130K to 450K on Google Play. Executed advanced funnel optimisation: tested a custom user flow that lifted Retention Rate d28 by 2 p.p. and session time by 15% with no CPI or ARPU d7 increase. Delivered a 38% ARPU d7 uplift on Google Ads campaigns via GEO-specific user flow.",
      "Previously Head of UA at a mobile games studio, leading in-house UA across 10+ idle titles with hybrid monetisation (50:50). Doubled YoY gross profit, scaled a key iOS title's spend 3x on Meta using SKAN and AEM, and built a channel-specific creative testing framework from scratch.",
      "Earlier UA Lead at a casual mobile studio (IAA monetised): scaled a casual title's Android traffic 4x while meeting strict ROAS KPIs.",
      "Senior UA Manager at a mobile games publisher (IAP heavy): doubled ROAS d30 on a casual title by shifting 50% of spend into re-engagement for LTV growth.",
      "Senior UA Manager at a dating company (IAP heavy): doubled YoY revenue with positive ROI across a mobile app portfolio, including DSP scaling on Liftoff, DBM, and Spotad.",
      "Budgets: managed 7-figure monthly budgets on Google and Meta, 6-figure on AppLovin. Deep hands-on channel coverage across Unity, Mintegral, Liftoff, TikTok, ASA, Pinterest, Snapchat, incentivised sources and preinstall partners. Tooling fluency spans Adjust, AppsFlyer, Singular, Tableau, PowerBI, Incrmntal, Firebase and Fraudscore.",
    ],
    motivations:
      "Genuinely interested in the craft of how games are built; wants a studio where he can engage with product, not just run campaigns against it. Specifically drawn to working with an international team, which he hasn't had the chance to do before and flagged as a real pull factor. Looking for a leadership seat.",
    recruiterNotes: [
  ...
  },
  {
    ...
    background:
      "Motion designer and visual creative lead with 10+ years across apps, games, and brands. Trilingual (Dutch, English, Arabic). Open to relocation: Spain, UK, Finland, Dubai, Abu Dhabi. 1 month notice for full-time, sooner on part-time.",
    location: { code: "eu", label: "eu · remote" },
    industries: ["games", "apps"],
    gamesCat: ["casual", "hypercasual", "hybridcasual"],
    appsCat: ["lifestyle", "productivity", "entertainment"],
    genre: [],
    channels: ["meta", "tiktok", "google", "programmatic"],
    formats: ["video", "motion", "playable", "ugc"],
    expertise: ["scaling", "audience"],
    dayRateLabel: "€200 to €400 / day",
    dayRateBand: 0,
    rateMin: 170,
    rateMax: 340,
    salaryAnnualLabel: "€44,000 / year",
    salaryAnnual: 37000,
    available: true,
    availableFor: ["permanent", "contract"],
    summary:
      "Ten years of performance-driven motion and ad creative with a strong production instinct: builds videos around a product's biggest draws, iterates on winners, and works up from USPs and storylines. Track record spans 35+ apps, 750+ live-game visuals, and a company-first interactive HTML5 ad. Runs weekly and bi-weekly ideation sessions and 20-to-30-ad briefing across clients in tight collaboration with UA. Wants back into a team after a stretch of freelancing.",
    skills: [
      "Motion Design & Animation",
      "UA Video / Ad Creative",
      "Creative Direction & Production",
      "Brief Creation & Ideation",
      "Interactive / HTML5 Ads",
      "UGC-Style Creative",
      "Branding & Visual Identity",
      "Adobe CC (After Effects, Photoshop)",
      "Motion Graphics",
      "Screen Capture (Bandicam)",
      "Stakeholder & UA Comms",
    ],
    experience: [
      "Motion designer and visual creative lead with 10+ years making high-performing digital content for apps, games, and brands. Specialises in performance-driven motion design, interactive advertising, and brand systems, and has led creative teams throughout.",
      "Most recently Content Producer and Motion Designer at a growth and performance-marketing company (games, apps, and products) for ~3 to 4 years: led a 4-person creative team delivering marketing assets for mobile apps, directed digital campaigns across paid social and web, and optimised creatives against performance data while improving production workflows. Now freelancing, with some work on the side, and looking to return to a full-time role.",
      "Earlier spent ~4 years at a casual games company, starting as a graphic designer in a small team and moving into the growth team as a motion designer: designed performance-marketing visuals for 35+ mobile apps, produced 750+ visuals for live mobile and web games, built the company's first interactive HTML5 ad, and led weekly creative ideation for acquisition campaigns.",
      "As team lead on the in-house and apps side there, ran full brainstorm sessions from first principles (USPs, storylines) to make sure each video reflected a game or app's biggest draws, did extensive research for other creatives, and built briefs for 20 to 30 ads across clients in close collaboration with the UA manager; later moved into UGC-style creative, which apps in particular needed.",
      "Consistent operating pattern of iterating on winning creatives and building new concepts to fit context, staying hands-on producing the work himself and focusing effort on what matters most, with a bi-weekly creative cadence around results and ideas.",
      "Foundations as a graphic designer on game UI and live-game visual assets (750+), plus a multimedia-design education (marketing, web, and app design) and earlier vocational training in photography, video editing, and animation. Toolset spans Adobe CC, After Effects, Photoshop, motion graphics, and screen capture.",
    ],
    motivations:
      "Wants a full-time role again, in games or apps, ideally working in a team after a stretch of freelancing. Sees his sweet spot across motion design, ad creation, art direction, and creative production, and is open to a creative-producer or motion-design lead remit that includes leadership, brief creation, and stakeholder and UA communication. Open to relocation: Spain and the UK are his ideal destinations, and also open to Finland, Dubai, and Abu Dhabi.",
    recruiterNotes: [
      "Ten years of performance-driven motion and ad creative with a strong production instinct: builds videos around a product's biggest draws, iterates on winners, and works up from USPs and storylines, with a track record spanning 35+ apps, 750+ live-game visuals, and a company-first interactive HTML5 ad. Stays hands-on making the work while focusing effort where it counts.",
      "A team-oriented lead who has run a 4-person creative team, weekly and bi-weekly ideation sessions, and 20 to 30-ad briefing across clients in tight collaboration with UA. Comfortable across the full remit (motion design, art direction, creative production, brief creation, and stakeholder and UA comms), and explicitly wants back into a team after freelancing.",
      "Distinctive breadth from motion and interactive through branding and UGC-style creative, trilingual (Dutch, English, Arabic), and relocation-ready across Spain, the UK, Finland, Dubai, and Abu Dhabi.",
    ],
  },
  {
    id: "ua-06",
    ...
    budget: 3,
    expertise: ["scaling", "audience", "reactivation", "skan"],
    dayRateLabel: "£600 / day",
    dayRateBand: 2,
    rateMin: 600,
    salaryAnnualLabel: "€70,000 to €90,000 / year",
    salaryAnnual: 60000,
    salaryAnnualMax: 76000,
    available: true,
    availableFor: ["permanent", "contract"],
    summary:
      "Complete growth operator with 11 years covering production, ad-network UA, publishing build-out, and studio growth leadership. Manages 7-figure monthly budgets across every major network on titles with 500M+ lifetime downloads. Strong on measurement, creative testing, ASO, and ad-mon. Distinctive breadth from having sat on all sides of mobile growth (producer, ad network, publisher, and studio) and across both a large regional market and the global market.",
    skills: [
      "Growth Management",
      "User Acquisition",
      "Performance Marketing (Meta / Google / TikTok / DSPs)",
      "Ad Monetisation",
      "ASO",
      "Funnel & Monetisation Optimisation",
      "Creative Testing Strategy",
      "Attribution & Analytics (AppsFlyer / Adjust / MMPs)",
      "Marketing Automation & Data Pipelines",
      "Seven-Figure Budget & ROI",
      "Team Leadership",
    ],
    experience: [
      "11 years in mobile, spanning game production, ad-network UA, publishing, and growth leadership, with 10+ years focused on growing mobile apps and games through paid acquisition and continuous experimentation. Comfortable from early scale up to seven-figure monthly budgets.",
      "Most recently Senior Growth Manager at a hypercasual-to-hybrid-casual mobile games studio: owned end-to-end growth on assigned titles (all UA, campaign design and hands-on build, ASO, and ad-monetisation setup) across seven-figure monthly budgets on AppLovin, Unity, ironSource, Mintegral, TikTok, Meta, Google, incentivised, and programmatic. The portfolio included apps with 500M+ lifetime downloads. Partnered with data science to automate bidding (90% less manual work), built a systematic creative-testing and ASO experimentation pipeline, and reported to the Head of Growth and C-level while collaborating with data science and creative.",
      "Before Germany, Digital Marketing Lead at a mobile apps growth company, leading a 5-person cross-functional growth team (UA, retention, LiveOps). Rebuilt performance-marketing processes end to end (attribution pipelines, optimisation frameworks, new paid channels) and built executive reporting dashboards for growth, monetisation, and retention.",
      "Earlier, Growth Lead at a major regional app store and publishing operation, where he built the publishing and growth department from scratch to 11 people across marketing, product, and publishing. Within ~2 years the operation had 5 titles in the store's top-10 grossing and ~60M monthly users, driven by large-scale UA, retargeting, ASO, and cohort-led experimentation.",
      "Foundations at a mobile advertising network (UA, retargeting, and re-engagement; key accounts representing 50%+ of network traffic; programmatic media buying across SSPs and RTB) and, at the very start, ~3 years as a Game Producer shipping 3 successful mobile games on a large regional store (60M+ users) using agile Scrum and Kanban.",
    ],
    motivations:
      "Deliberately moving toward leadership, looking to provide influence and impact for growing teams. Open to both apps and gaming companies.",
    recruiterNotes: [
      "Complete growth operator: 11 years covering production, ad-network UA, publishing build-out. Managing UA on titles with 500M+ downloads and 7-figure monthly budgets. Strong on measurement, creative testing, ASO, and ad-mon, and fluent across every major network.",
      "Leadership is the clear next step and a real strength: built an 11-person department from scratch, led 5-person cross-functional growth teams (UA, data, LiveOps), mentored and onboarded growth hires, and set up scalable processes and KPIs.",
      "Distinctive breadth from having sat on all sides of mobile growth (producer, ad network, publisher, and studio) and across both a large regional home market and the global market after relocating to Germany.",
    ],
  },
];
